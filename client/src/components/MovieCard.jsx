...
const MovieCard = ({movie}) => {
  ...
  return (
    ...
    transition duration-300 w-66'>
      ...
      <p className='text-sm tex-gray-400 mt-2'>{new Date(movie.release_date).getFullYear()} • {movie.genres.slice(0,2).map(genre => genre.name).join("|")}•{timeFormat(movie.runtime)}</p>
